...
export const dbToApp = {
  ...
  expense: (row: any) => ({
    ...
    comment: row.comment,
    isForSpecialEmployee: row.is_for_special_employee,
    specialEmployeeId: row.special_employee_id,
  }),
  ...
  lead: (row: any) => ({
    ...
    amountCustoms: row.amount_customs ? Number(row.amount_customs) : undefined,
    amountCar: row.amount_car ? Number(row.amount_car) : undefined,
    amountRecycling: row.amount_recycling ? Number(row.amount_recycling) : undefined,
    amountFee: row.amount_fee ? Number(row.amount_fee) : undefined,
    amountDeposit: row.amount_deposit ? Number(row.amount_deposit) : undefined,
    amountOther: row.amount_other ? Number(row.amount_other) : undefined,
...
export const appToDb = {
  ...
  expense: (exp: any) => ({
    ...
    comment: exp.comment,
    is_for_special_employee: exp.isForSpecialEmployee,
    special_employee_id: exp.specialEmployeeId,
  }),
  ...
  lead: (lead: any) => ({
    ...
    team_id: lead.teamId,
    amount: lead.amount,
    amount_customs: lead.amountCustoms,
    amount_car: lead.amountCar,
    amount_recycling: lead.amountRecycling,
    amount_fee: lead.amountFee,
    amount_deposit: lead.amountDeposit,
    amount_other: lead.amountOther,
